...
> ⚠️ Проект в разработке. Основные системы мультиплеера реализованы, но полная синхронизация всё ещё дорабатывается.
...
- Локальная сеть или виртуальная LAN (для игры по интернету)  
...
### 🔹 ~~Не-Steam версия~~
## DCCM сейчас работает только со Steam!
Если у вас **не-Steam версия** Dead Cells:

1. Скачайте последний релиз **DCCM** из официального репозитория:  
   👉 [https://github.com/dead-cells-core-modding/core](https://github.com/dead-cells-core-modding/core)

2. Откройте каталог игры Dead Cells.

3. Создайте папку `coremod`.

4. Распакуйте файлы DCCM в папку `coremod`.
...
1. Откройте [https://steamcommunity.com/sharedfiles/filedetails/?id=3655044722](https://steamcommunity.com/sharedfiles/filedetails/?id=3657857836)
2. Установите мод в один клик.

---

### 🔹 Не-Steam версия (DCCM пока не поддерживает не-Steam)
...
4. Введите **IP-адрес** и **порт**  
5. Когда хост начнёт игру, клиент автоматически подключится к сессии  

🌐 **Для игры по интернету** можно использовать виртуальную LAN, например:
- Hamachi  
- Radmin VPN  
- ZeroTier  
...
- [x] Анимации призрака  
- [x] Качество анимаций призрака  
- [x] Синхронизация генерации уровня  
- [x] Синхронизация врагов  
- [x] Обработка смерти призрака  
- [x] Больше взаимодействий  
- [x] Синхронизация боссов  
